...
def on_webview_will_set_content(web_content: WebContent, context) -> None:
    ...
    mw.addonManager.setWebExports(__name__, r"web/trees/AppleTree.*\.")
...
def create_iframe_html(general_url, treeType, stage, progress, max, display):
    ...
    html_code += f"""<div id="TreeWindow" class="draggable"><iframe id="Trefame" src='{general_url}/treeFrame.html?treeType={treeType}&stage={stage}&current={progress}&max={max}' style="display:{display};"></iframe></div>"""
    html_code += """
        <script>
